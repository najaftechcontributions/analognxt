        ...
        window.tram = (function (t) {
          ...
          var $ = (e.frame =
              (s =
                ...
                h.msRequestAnimationFrame) && T.bind
                ? s.bind(h)
                : function (t) {
                    h.setTimeout(t, 16);
                  }),
            ...
            F = l(function (e) {
              function o() {
                var t,
                  ...
                  i = u.length;
                if (i)
                  for ($(o), e = D(), t = i; t--; ) (n = u[t]) && n.render(e);
              }
          ...
          ((e.fallback = function (t) {
            if (!T.transition) return (W.fallback = !0);
            W.agentTests.push("(" + t + ")");
          ...
          var H = t.style,
            B = t.css,
            G = { transform: T.transform && T.transform.css },
            X = {
              color: [M, g],
          ...
          (t.exports = function (t, e) {
            ...
            function A(n, i) {
              ...
              (v ||
                ...
                (v.outside =
                  ((r = v).outside && f.off("click" + m, r.outside),
                  function (e) {
                    var n = t(e.target);
              ...
              c.preview =
                function () {
                  ((s = p && i.env("design")),
                    (u = i.env("editor")),
                    (n = t(document.body)),
                    (a = f.find(m)).length && (a.each(A), E(), i.resize.on(_)));
                }),
              (c.destroy = function () {
            ...
            function N(e, n) {
              ...
              if ((!i.open || r || s || F(i, !0), i.container.length)) {
                var o,
                  a =
                    ("none" === (o = i.container.css(z)) && (o = ""),
                    function (e, n) {
                      ((n = t(n)).css(z, ""),
                        "none" === n.css(z) && n.css(z, o));
                    });
